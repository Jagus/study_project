...
<body>
    ...
    <div class="wrap">
        <?php
            NavBar::begin([
                'brandLabel' => Yii::t('frontend','Project Sieki'), //
    ...
    <footer class="footer">
        <div class="container">
        <p class="pull-left"><? echo Html::a('&copy; Sieki Team '.date('Y'),'http://lookahead.io'); ?></p>
        <p class="pull-right"><?= Html::a(Yii::t('frontend','Follow').' @Sieki Team','https://twitter.com/intent/user?screen_name=meetingio') ?></p>
        </div>
    </footer>
